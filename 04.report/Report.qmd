...
- Ambition Score: A "Lexical Hardness" index comparing mandatory ("legally", "must", "mandatory") vs. aspirational ("aim", "seek", "aspire") language, utilizing a smoothing constant ($+0.001$) to handle zero-count denominators in shorter documents.
...
![The Ambition Audit](../03.output/ndc_cpdb_comparison_table.png){width=50%}
