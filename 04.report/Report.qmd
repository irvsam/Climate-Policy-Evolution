...
**Visualization:** Figure 2 shows Adaptation Mix (% of portfolio dedicated to adaptation) for each country, sorted by ND-GAIN vulnerability score.
...
**Visualization:** Figure 3 (the **Ambition Matrix**) plots Lexical Hardness (y-axis) vs. Adaptation Focus (x-axis) for each country's NDC.
