...
![Table 1: The Ambition Audit](../03.output/ndc_cpdb_comparison_table.png){width=60%}
...
The findings discussed above provide clear evidence for climate justice debates: the Global South prioritizes adaptation, but lacks the resources to codify commitments into binding law. 
