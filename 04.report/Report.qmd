...
The ND-GAIN Index provides the context of necessity. The ND-GAIN scores are a composition of vulnerability and readiness indicators, allowing us to benchmark countries based on their climate risk and adaptive capacity.
...
Zooming in to our chosen list of countries we are able to see the spread of each policy portfolio. What percentage of implemented policies focus on adaptation. The ND-GAIN scores have been added in order to visualize the comparison of vulnerability. There seems to be an uneven relationship between vulnerability and implementation. While some vulnerable nations like Rwanda show a high adaptation ratio, others like India lag behind. This would suggest that vulnerability may not be a driving factor in adaptation adoption. However, it is important to think about what other reasons there may be for this unclear relationship. Two problems arise here 1) the tracking of adaptation is historically complex and most often underreported, particularly for the Global South, and 2) the CPDB data has a bias towards Global North countries, meaning that the adaptation efforts of the Global South may be underrepresented. This is why I chose to supplement this analysis with an NLP-based analysis of the NDCs, which allows us to capture strategic intent and "mindshare" around adaptation that may not be reflected in the CPDB data.
...
## Adaptation Focus vs. Ambition in NDCs (The Commitment Gap)
