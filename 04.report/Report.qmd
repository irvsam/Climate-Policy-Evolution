...
abstract: "This report documents a data mining pipeline bringing together multiple separate sources of climate data. The exploration analyzes the evolution of climate strategies since the Paris agreement (2015), with a particular focus on the integration of adaptation measures alongside mitigation efforts in a select group of countries."
format:
  pdf:
    toc: true
    toc-depth: 1
