...
## Finding 3: The Survival Ratio (Vulnerability → Adaptation)
...
## Finding 4: The Responsibility Gap (Global North vs. Global South)
This finding emerged from my analysis of the NDC texts, where I used NLP techniques to quantify the focus on adaptation vs. mitigation (keyword frequency). This compares to figure 3 which is based on the CPDB policy data. The NDC analysis allows us to see how countries frame their commitments in their official climate pledges.

**Visualization:** Figure 3 (the **Adaptation Leaderboard**) plots the Adaptation Focus Score (keyword frequency) for each country's NDC, sorted by ND-GAIN vulnerability score.
**Observation:** Global South countries (e.g., Rwanda, South Africa, India) have much higher Adaptation Focus Scores compared to Global North countries (e.g., Germany, Denmark).
